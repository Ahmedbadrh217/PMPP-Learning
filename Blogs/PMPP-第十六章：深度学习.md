...
前面我们学习了各种并行算法原语：归约、扫描、排序、稀疏矩阵、图遍历。这些技术在深度学习中都有用武之地。第十六章将这些技术串联起来，展示 GPU 如何加速**深度学习**——这是当今 GPU 最重要的应用之一。本章不会深入讲解神经网络理论，而是聚焦于**计算视角**：神经网络的核心操作是什么？GPU 如何高效实现它们？
