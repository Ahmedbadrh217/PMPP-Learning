...
经过前十八章的学习，我们掌握了 CUDA 编程的各种技术细节。第十九章是全书的总结与升华，从"术"上升到"道"——**计算思维（Computational Thinking）**。这一章不再讲具体的 API 或优化技巧，而是讨论**如何思考并行问题**、**如何设计并行算法**、**如何权衡各种因素**。这些思维方式将帮助你应对未来遇到的任何并行计算挑战。
